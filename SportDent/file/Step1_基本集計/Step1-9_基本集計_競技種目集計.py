...
【目的】
「競技種目」ごとの件数・割合・順位を集計し、競技別の事例分布を確認する。
...
【実行例】
python file/Step1_基本集計/Step1-9_基本集計_競技種目集計.py
...
TARGET_COLUMN = "競技種目"
OUTPUT_CSV = OUTPUT_DIR / "Step1-9_基本集計_競技種目集計.csv"


def main() -> None:
    start = time.perf_counter()
    print("=" * 70)
    print("Step1-9_基本集計_競技種目集計")
    print("解析方法：記述統計")
    ...
    print("\n" + "━" * 70)
    print("Step1-9_基本集計_競技種目集計 完了")
    print(f"出力：{OUTPUT_CSV}")
    print(f"処理時間：{elapsed:.2f}秒")
    print("同名CSVは上書きしています。")
    print("ジャッカード係数：使用しない")
    print("次：Step1-10_基本集計_遊具等集計.py")
    print("━" * 70)
