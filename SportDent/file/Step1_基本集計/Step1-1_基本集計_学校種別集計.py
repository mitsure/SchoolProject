...
【目的】
元データ全体について、「被災学校種」ごとの件数・割合・順位を集計する。

【Pythonファイルの配置先】
Meikai/file/Step1-1_基本集計_学校種別集計.py
...
【実行例】
python file/Step1-1_基本集計_学校種別集計.py
==========================================================
"""
...
OUTPUT_CSV = OUTPUT_DIR / "Step1-1_基本集計_学校種別集計.csv"
