...
【目的】
「場合別1」と「場合別2」の組合せごとに件数・割合・順位を集計する。
...
【実行例】
python file/Step1_基本集計/Step1-6_基本集計_場合別集計.py
...
COLUMN_1 = "場合別1"
COLUMN_2 = "場合別2"
OUTPUT_CSV = OUTPUT_DIR / "Step1-6_基本集計_場合別集計.csv"


def main() -> None:
    start = time.perf_counter()
    print("=" * 70)
    print("Step1-6_基本集計_場合別集計")
    ...
    print("\n" + "━" * 70)
    print("Step1-6_基本集計_場合別集計 完了")
    print(f"出力：{OUTPUT_CSV}")
    print(f"処理時間：{elapsed:.2f}秒")
    print("同名CSVは上書きしています。")
    print("ジャッカード係数：使用しない")
    print("次：Step1-7_基本集計_通学方法集計.py")
    print("━" * 70)
