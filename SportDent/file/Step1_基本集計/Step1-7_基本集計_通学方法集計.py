...
【目的】
「通学方法」ごとの件数・割合・順位を集計し、欠損状況も確認する。

【Pythonファイルの配置先】
Meikai/file/Step1_基本集計/
└─ Step1-7_基本集計_通学方法集計.py
...
【実行例】
python file/Step1_基本集計/Step1-7_基本集計_通学方法集計.py

【次のStep】
Step1-8_基本集計_年度別集計.py
==========================================================
"""
...
TARGET_COLUMN = "通学方法"
OUTPUT_CSV = OUTPUT_DIR / "Step1-7_基本集計_通学方法集計.csv"


def main() -> None:
    start = time.perf_counter()
    print("=" * 70)
    print("Step1-7_基本集計_通学方法集計")
    print("解析方法：記述統計")
    ...
    print("\n" + "━" * 70)
    print("Step1-7_基本集計_通学方法集計 完了")
    print(f"出力：{OUTPUT_CSV}")
    print(f"処理時間：{elapsed:.2f}秒")
    print("同名CSVは上書きしています。")
    print("ジャッカード係数：使用しない")
    print("次：Step1-8_基本集計_年度別集計.py")
    print("━" * 70)
