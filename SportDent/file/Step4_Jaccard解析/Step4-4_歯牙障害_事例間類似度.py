...
"""
Step4-4_Jaccard解析_歯牙障害_事例間類似度

歯牙障害の各事例について、語特徴・カテゴリ特徴・統合特徴の
...
OUTPUT_WORD = OUTPUT_DIR / "Step4-4_歯牙障害_語特徴_類似事例上位.csv"
OUTPUT_CATEGORY = OUTPUT_DIR / "Step4-4_歯牙障害_カテゴリ特徴_類似事例上位.csv"
OUTPUT_COMBINED = OUTPUT_DIR / "Step4-4_歯牙障害_統合特徴_類似事例上位.csv"
OUTPUT_SUMMARY = OUTPUT_DIR / "Step4-4_歯牙障害_解析サマリー.csv"
    ...
    try:
        ...
        summary = pd.DataFrame(
            [
                ...
                ("ジャッカード係数", "使用する"),
                ("次のStep", "Step4-5_All_vs歯牙障害比較.py"),
            ],
            columns=["項目", "値"],
        )
        ...
        print("\n正常終了")
        print("次: Step4-5_All_vs歯牙障害比較.py")
