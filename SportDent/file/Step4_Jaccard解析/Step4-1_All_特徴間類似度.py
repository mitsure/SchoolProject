...
"""
Step4-1_Jaccard解析_All_特徴間類似度

Step3-7_Allの事例別特徴データから、特徴同士の出現事例集合を作り、
...
OUTPUT_WORD = OUTPUT_DIR / "Step4-1_All_語特徴間Jaccard.csv"
OUTPUT_CATEGORY = OUTPUT_DIR / "Step4-1_All_カテゴリ特徴間Jaccard.csv"
OUTPUT_COMBINED = OUTPUT_DIR / "Step4-1_All_統合特徴間Jaccard.csv"
OUTPUT_SUMMARY = OUTPUT_DIR / "Step4-1_All_解析サマリー.csv"
...
def main() -> None:
    ...
    try:
        ...
        print("\n正常終了")
        print("次: Step4-2_歯牙障害_特徴間類似度.py")
