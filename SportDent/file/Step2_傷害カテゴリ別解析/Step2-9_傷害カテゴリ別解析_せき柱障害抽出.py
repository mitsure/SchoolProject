...
"""
==========================================================
Step2-9_傷害カテゴリ別解析_せき柱障害抽出

【目的】
元データから「種別」が「せき柱障害」の事例だけを抽出し、
...
【実行例】
python file/Step2_傷害カテゴリ別解析/Step2-9_傷害カテゴリ別解析_せき柱障害抽出.py
==========================================================
"""
...
def main() -> None:
    ...
    print("=" * 76)
    print("Step2-9 傷害カテゴリ別解析：せき柱障害抽出")
    print("解析方法：条件抽出")
