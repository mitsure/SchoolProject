...
"""
==========================================================
Step2-10_傷害カテゴリ別解析_聴力障害抽出

【目的】
元データから「種別」が「聴力障害」の事例だけを抽出し、
...
【実行例】
python file/Step2_傷害カテゴリ別解析/Step2-10_傷害カテゴリ別解析_聴力障害抽出.py
==========================================================
"""
...
def main() -> None:
    ...
    print("=" * 76)
    print("Step2-10 傷害カテゴリ別解析：聴力障害抽出")
    print("解析方法：条件抽出")
