...
"""
==========================================================
Step2-20_傷害カテゴリ別解析_年度別比較

【目的】
各傷害カテゴリについて、給付年度ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("=" * 78)
    print("Step2-20 傷害カテゴリ別解析：年度別比較")
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step3-1_テキストマイニング_形態素解析.py")
    print("━" * 78)
