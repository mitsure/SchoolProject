...
"""
==========================================================
Step2-14_傷害カテゴリ別解析_学年比較

【目的】
各傷害カテゴリについて、学校種・学年ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    try:
        ...
        work["被災学校種"] = normalize(work["被災学校種"])
        work["被災学年"] = normalize(work["被災学年"])
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-15_傷害カテゴリ別解析_性別比較.py")
    print("━" * 78)
