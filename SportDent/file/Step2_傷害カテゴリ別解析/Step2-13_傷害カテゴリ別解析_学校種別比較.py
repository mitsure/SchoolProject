...
"""
==========================================================
Step2-13_傷害カテゴリ別解析_学校種別比較

【目的】
各傷害カテゴリについて、学校種ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("=" * 78)
    print("Step2-13 傷害カテゴリ別解析：学校種別比較")
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-14_傷害カテゴリ別解析_学年比較.py")
    print("━" * 78)
