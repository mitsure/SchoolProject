...
"""
==========================================================
Step2-17_傷害カテゴリ別解析_場合別比較

【目的】
各傷害カテゴリについて、場合別分類ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("=" * 78)
    print("Step2-17 傷害カテゴリ別解析：場合別比較")
    ...
    try:
        ...
        work["場合別1"] = normalize(work["場合別1"])
        work["場合別2"] = normalize(work["場合別2"])
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-18_傷害カテゴリ別解析_通学方法比較.py")
    print("━" * 78)
