...
"""
==========================================================
Step2-6_傷害カテゴリ別解析_胸腹部臓器障害抽出

【目的】
元データから「種別」が「胸腹部臓器障害」の事例だけを抽出し、
...
└─ Step2-6_傷害カテゴリ別解析_胸腹部臓器障害抽出.csv
...
【実行例】
python file/Step2_傷害カテゴリ別解析/Step2-6_傷害カテゴリ別解析_胸腹部臓器障害抽出.py
==========================================================
"""
...
def main() -> None:
    ...
    print("=" * 76)
    print("Step2-6 傷害カテゴリ別解析：胸腹部臓器障害抽出")
    print("解析方法：条件抽出")
