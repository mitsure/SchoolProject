...
"""
==========================================================
Step2-3_傷害カテゴリ別解析_視力・眼球運動障害抽出

【目的】
元データから「種別」が「視力・眼球運動障害」の事例だけを抽出し、
...
└─ Step2-3_傷害カテゴリ別解析_視力・眼球運動障害抽出.csv
...
【実行例】
python file/Step2_傷害カテゴリ別解析/Step2-3_傷害カテゴリ別解析_視力・眼球運動障害抽出.py
==========================================================
"""
...
def main() -> None:
    ...
    print("=" * 76)
    print("Step2-3 傷害カテゴリ別解析：視力・眼球運動障害抽出")
    print("解析方法：条件抽出")
