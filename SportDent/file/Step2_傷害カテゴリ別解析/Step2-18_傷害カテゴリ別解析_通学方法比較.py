...
"""
==========================================================
Step2-18_傷害カテゴリ別解析_通学方法比較

【目的】
各傷害カテゴリについて、通学方法ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("=" * 78)
    print("Step2-18 傷害カテゴリ別解析：通学方法比較")
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-19_傷害カテゴリ別解析_競技種目比較.py")
    print("━" * 78)
