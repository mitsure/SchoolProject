...
"""
==========================================================
Step2-16_傷害カテゴリ別解析_発生場所比較

【目的】
各傷害カテゴリについて、発生場所の大分類・小分類ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("=" * 78)
    print("Step2-16 傷害カテゴリ別解析：発生場所比較")
    ...
    try:
        ...
        work["発生場所1"] = normalize(work["発生場所1"])
        work["発生場所2"] = normalize(work["発生場所2"])
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-17_傷害カテゴリ別解析_場合別比較.py")
    print("━" * 78)
