...
"""
==========================================================
Step2-15_傷害カテゴリ別解析_性別比較

【目的】
各傷害カテゴリについて、性別ごとの件数・割合・順位を比較する。
...
def main() -> None:
    ...
    print("ジャッカード係数：使用しない")
    print("次：Step2-16_傷害カテゴリ別解析_発生場所比較.py")
    print("━" * 78)
