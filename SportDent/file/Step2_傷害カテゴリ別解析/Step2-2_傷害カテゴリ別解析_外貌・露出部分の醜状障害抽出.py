...
"""
==========================================================
Step2-2_傷害カテゴリ別解析_外貌・露出部分の醜状障害抽出

【目的】
元データから「種別」が「外貌・露出部分の醜状障害」の事例だけを抽出し、
...
└─ Step2-2_傷害カテゴリ別解析_外貌・露出部分の醜状障害抽出.csv
...
【実行例】
python file/Step2_傷害カテゴリ別解析/Step2-2_傷害カテゴリ別解析_外貌・露出部分の醜状障害抽出.py
==========================================================
"""
...
def main() -> None:
    ...
    print("=" * 76)
    print("Step2-2 傷害カテゴリ別解析：外貌・露出部分の醜状障害抽出")
    print("解析方法：条件抽出")
